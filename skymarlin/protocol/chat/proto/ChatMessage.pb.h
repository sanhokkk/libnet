...
inline ::int32_t ChatMessage::client_id() const {
  // @@protoc_insertion_point(field_get:skymarlin.protocol.chat.ChatMessage.client_id)
  return _internal_client_id();
}
inline void ChatMessage::set_client_id(::int32_t value) {
  _internal_set_client_id(value);
  // @@protoc_insertion_point(field_set:skymarlin.protocol.chat.ChatMessage.client_id)
}
inline ::int32_t ChatMessage::_internal_client_id() const {
  PROTOBUF_TSAN_READ(&_impl_._tsan_detect_race);
  return _impl_.client_id_;
}
inline void ChatMessage::_internal_set_client_id(::int32_t value) {
  PROTOBUF_TSAN_WRITE(&_impl_._tsan_detect_race);
  ;
