...
#ifndef FLATBUFFERS_GENERATED_HELLO_SANHOK_NET_TESTS_H_
#define FLATBUFFERS_GENERATED_HELLO_SANHOK_NET_TESTS_H_
...
inline ::flatbuffers::Offset<Hello> CreateHelloDirect(
  ...
  return sanhok::net::tests::CreateHello(
      _fbb,
      hello__);
}

inline const sanhok::net::tests::Hello *GetHello(const void *buf) {
  return ::flatbuffers::GetRoot<sanhok::net::tests::Hello>(buf);
}

inline const sanhok::net::tests::Hello *GetSizePrefixedHello(const void *buf) {
  return ::flatbuffers::GetSizePrefixedRoot<sanhok::net::tests::Hello>(buf);
}

inline bool VerifyHelloBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifyBuffer<sanhok::net::tests::Hello>(nullptr);
}

inline bool VerifySizePrefixedHelloBuffer(
    ::flatbuffers::Verifier &verifier) {
  return verifier.VerifySizePrefixedBuffer<sanhok::net::tests::Hello>(nullptr);
}

inline void FinishHelloBuffer(
    ::flatbuffers::FlatBufferBuilder &fbb,
    ::flatbuffers::Offset<sanhok::net::tests::Hello> root) {
  fbb.Finish(root);
}
...
#endif  // FLATBUFFERS_GENERATED_HELLO_SANHOK_NET_TESTS_H_
